          ...
          <div className="bg-white/95 backdrop-blur-sm border shadow-lg rounded-2xl p-8 mb-6">
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <p className="text-gray-600 text-lg font-medium max-w-md mx-auto leading-relaxed">
                All About Bignalytics, One Chat Away.
              </p>
            </div>
          </div>
        </div>
              ...
              <CardContent className="space-y-4 max-h-[600px] overflow-y-auto p-6 custom-scrollbar">
                {chatHistory.length > 0 ? (
                  chatHistory.map((chat, index) => (
                    <Card key={index} className="p-4 bg-blue-50 border border-blue-200 shadow-sm rounded-xl">
                      ...
                      <div className="space-y-3">
                        <div className="bg-white rounded-lg p-3 border-l-4 border-blue-400">
                          ...
                          <p className="text-sm text-gray-600 whitespace-pre-wrap break-words leading-relaxed">{chat.question}</p>
                        </div>
                        <div className="bg-white rounded-lg p-3 border-l-4 border-blue-400">
                          <p className="text-sm font-semibold text-gray-700 mb-1">A:</p>
                          <p className="text-sm text-gray-600 whitespace-pre-wrap break-words leading-relaxed">{chat.answer}</p>
                        </div>
                        {chat.feedback && (
                          <div className="text-xs text-gray-500 bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            {chat.feedback.comment && (
                              <p className="mt-1 text-gray-600">{chat.feedback.comment}</p>
                            )}
                          </div>
                        )}
                      </div>
              ...
              <CardContent className="p-8">
                <form onSubmit={handleSubmitQuestion} className="space-y-6">
                  <div className="relative">
                    <Input
                      placeholder="Ask a question about Bignalytics coaching..."
                      value={question}
                      onChange={(e) => setQuestion(e.target.value)}
                      className="text-lg p-6 rounded-xl border-2 border-gray-300 focus:border-blue-400 bg-gray-50"
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <Textarea
                        ...
                        rows={4}
                        className="rounded-xl border-2 border-gray-300 focus:border-blue-400 bg-gray-50 text-lg p-4"
                      />
                    </div>
                    <Button
