          ...
          <div className="bg-white/95 backdrop-blur-sm border shadow-lg rounded-2xl p-8 mb-6">
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <div className="flex items-center justify-center gap-6">
                <img src="https://bignalytics.in/wp-content/uploads/2021/04/logo-1.png" alt="Bignalytics Logo" className="h-16 w-auto object-contain flex-shrink-0" />
              ...
              {/* Subtitle */}
              <p className="text-gray-500 max-w-md leading-relaxed px text-left **ml-2** text-lg px-[79px] py-0 my-[9px] mx-[62px] font-bold">All About Bignalytics, One Chat Away.</p>
            </div>
          </div>
        </div>
