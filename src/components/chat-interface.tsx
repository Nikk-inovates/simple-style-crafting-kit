...
export function ChatInterface({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 relative overflow-hidden">
        ...
        {!currentAnswer && !isLoading && (
          <div className="text-center py-16 max-w-2xl mx-auto animate-fade-in">
            <div className="mb-8">
              ...
              <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-gray-800 via-gray-600 to-gray-700 dark:from-gray-200 dark:via-gray-300 dark:to-gray-100 bg-clip-text text-transparent animate-fade-in delay-150">
                Bignalytics AI
              </h1>
                  ...
                  <Card className="p-6 border-gray-300 dark:border-gray-600 shadow-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl backdrop-saturate-150 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-3xl">
                    ...
                    <div className="flex gap-3 mb-5">
                      <Button
                        ...
                        className="flex-1 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-lg border-gray-300 dark:border-gray-600"
                      >
                    ...
                    <Textarea
                      ...
                      className="mb-5 rounded-2xl border-gray-300 dark:border-gray-600 resize-none transition-all duration-300 focus:ring-2 focus:ring-gray-500/20 focus:border-gray-500"
                      rows={3}
                    />
                    <Button
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          <div className="relative group">
            <Textarea
              ...
              className="resize-none pr-16 min-h-[60px] rounded-3xl border-2 border-gray-300 dark:border-gray-600 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm shadow-2xl focus:border-gray-500 dark:focus:border-gray-400 focus:bg-white dark:focus:bg-gray-800 transition-all duration-300 focus:ring-4 focus:ring-gray-500/10 group-hover:shadow-3xl"
            ...
            <Button
              ...
              className="absolute bottom-3 right-3 h-12 w-12 rounded-2xl shadow-2xl bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 transition-all duration-300 hover:scale-110 hover:shadow-3xl disabled:hover:scale-100 group"
            >
